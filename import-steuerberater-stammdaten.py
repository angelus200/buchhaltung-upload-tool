...
company_id = 90001  # Alpenland Heizungswasser KG

# ============ KREDITOREN ============
print("=== KREDITOREN IMPORT ===")
df_kred = pd.read_excel('/home/ubuntu/upload/Kreditorenstammdaten2025-AlpenlandHeizungswasserKG.xlsx', header=1)
...
# ============ DEBITOREN ============
print("\n=== DEBITOREN IMPORT ===")
df_deb = pd.read_excel('/home/ubuntu/upload/Debitorenstammdaten2025-AlpenlandHeizungswasserKG.xlsx', header=1)
